...
public class BicingDemoEx4 {
    public static void main(String[] args) {
        ...
        //printea algo
        System.out.println("E,"+"B,"+ "F,"+ "TIEMPO");
        for(int i = 0; i < seeds.length; ++i){
            for(int j = 25; j < 25*15; j = j +25){
                int nest = j;
                int nbic = j*50;
                int nfurg = j/5;
                int dem = 0;
                int seed = seeds[i];
                int iniTrivial = 1; //hemos visto que el bueno es greedy pues usamos el greedy
                int heuristica = 0;
                int hillClimbing = 1;
                ...
                System.out.println(nest+ "," + nbic + "," + nfurg + "," + elapsedTime/1000);
                }
             }
             //printea dos lieas
            System.out.println();
