...
public class BicingEstado{
    ...
    private Estaciones estaciones;
        public BicingEstado(Estaciones estaciones, int[] conj_operadores) {
        this.estaciones = estaciones;
        this.operadores = conj_operadores;
   ...
   public void CambiarOrigen(int Idfurg,int IDnewOrigin){
    ...
    public BicingEstado(BicingEstado e){
        ...
        operadores= new int[e.operadores.length];
        for (int i = 0; i < e.operadores.length; i++) {
          operadores[i]=e.operadores[i];
        }
    }
