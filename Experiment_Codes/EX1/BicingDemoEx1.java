...
public class BicingDemoEx1 {

    public static void main(String[] args) {
        int seeds[] = {0,3756, 583, 84787, 263, 7085, 25, 2884, 9683, 25654, 4983};

        int conj_operadores[][] = new int[12][6];
        conj_operadores[0] = new int[]{1,0,0,0,0,0};
        conj_operadores[1] = new int[]{1,1,0,0,0,0};
        conj_operadores[2] = new int[]{1,1,1,0,0,0};
        conj_operadores[3] = new int[]{1,1,1,1,0,0};
        conj_operadores[4] = new int[]{1,1,1,1,1,0};
        conj_operadores[5] = new int[]{1,1,1,1,1,1};
        conj_operadores[6] = new int[]{1,0,1,0,0,0};
        conj_operadores[7] = new int[]{1,1,0,1,0,0};
        conj_operadores[8] = new int[]{1,0,0,0,1,0};
        conj_operadores[9] = new int[]{1,0,1,0,1,0};
        conj_operadores[10] = new int[]{1,1,0,0,1,1};
        conj_operadores[11] = new int[]{1,1,0,1,1,1};

        // Estaciones(int nest, int nbic, int dem, int seed) Constructor
        // cogemos los datos de la entrada
        for(int i = 0; i < seeds.length; ++i){
            for(int j = 0; j < conj_operadores.length;++j){
                //printea j
                if(i != 0)System.out.println("Conjunto de operadores: " + j);
                int nest = 25;
                int nbic = 1250;
                int nfurg = 5;
                int dem = 0;
                ...
                BicingEstado furgonetas = new BicingEstado(estaciones,conj_operadores[j]);
